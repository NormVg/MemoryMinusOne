...
import { MemoryMinusOneProvider } from "./memoryminusone"
...
const providers: Record<ProviderName, new () => Provider> = {
  ...
  rag: RAGProvider,
  memoryminusone: MemoryMinusOneProvider,
}
...
export { SupermemoryProvider, Mem0Provider, ZepProvider, FilesystemProvider, RAGProvider, MemoryMinusOneProvider }
